"""Gate: tests/ must be English except intentionally marked CJK fixtures (#3341)."""
...
def _is_marked(lines: list[str], idx: int) -> bool:
    ...
    Lookback is 40 lines so dense Issue-body fixtures (product still uses
    Japanese section headers) can be marked once per contiguous block.
    """
